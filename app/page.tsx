                                ...
                                <div key={card.id} className="relative group rounded-[2rem] bg-black border border-white/10 hover:border-neon-blue/50 p-6 transition-all duration-300 overflow-hidden">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <div className="grid grid-cols-3 gap-2 mb-6">
                                            <div className="bg-white/5 rounded-lg p-2 text-center border border-white/5 group hover:border-neon-blue/50 hover:bg-white/10 transition cursor-pointer relative overflow-hidden text-neon-blue"
                                                onClick={() => setLeadViewerState({
                                                    isOpen: true,
                                                    leads: leads.filter((l: any) => l.card_id === card.id),
                                            ...
                                            >
                                                ...
                                                <div className="text-xl font-bold text-white font-rajdhani mb-1">{leads.filter((l: any) => l.card_id === card.id).length}</div>
                                                <div className="text-[9px] text-neon-blue opacity-0 group-hover:opacity-100 uppercase tracking-wider font-bold transition-opacity absolute bottom-1 left-0 right-0">View List</div>
                                            </div>
