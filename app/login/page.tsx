...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center bg-cyber-grid bg-[length:40px_40px] p-4">

            <div className="glass-panel w-full max-w-md rounded-2xl border border-white/10 relative overflow-hidden flex flex-col">
                {/* Decorative Glow */}
                ...
                <div className="p-8">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className="text-white/50 text-sm mt-2">
                            {mode === 'LOGIN' ? 'ACCESSING SECURE MAINFRAME' : 'INITIALIZING NEW PROTOCOL'}
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleAuth} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-neon-blue uppercase tracking-wider">Agent Identity (Email)</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-neon-blue uppercase tracking-wider">Access Code (Password)</label>
                            <div className="relative">
                        ...
                        >
                            {loading ? 'Processing...' : (mode === 'SIGNUP' ? 'Initialize Account' : 'Authenticate')}
